...
Pass `model` as your billing model ID — see "Model identification" below to derive it from your system prompt (or pass `"unknown"`). Set `client` to `"claude-code"`. USE IN PLAN OR AGENT MODE.
